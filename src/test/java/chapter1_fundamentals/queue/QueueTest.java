...
public abstract class QueueTest {
	...
	public abstract Queue<Object> createObjectQueue();
	public abstract Queue<Integer> createIntegerQueue();
	
	@Test
	public void testStackSizePushPop() {
		
		//Create an empty queue. Test that its size is 0.
		Queue<Object> queue = createObjectQueue();
	...
	public void testStackIterator() {
		Queue<Integer> queue =createIntegerQueue();
